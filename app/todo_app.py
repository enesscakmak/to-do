...
class ToDoApp:
    def __init__(self, root):
        ...
        style_button.configure("TButton", foreground="black")
        ...
        for col in ["ID", "Title", "Description", "Priority", "Finish By", "Completed"]:
            self.task_treeview.heading(col, text=col, anchor="center")
