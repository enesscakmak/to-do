...
class AddTaskWindow:
    def __init__(self, parent):
        ...
        self.completed_entry = ttk.Checkbutton(self.window, text="", variable=self.varCompleted)
    ...
    def add_task(self):
        ...
        if title and description and priority and finish_by:  # Remove the check for 'completed'
